...
static CLAP_CONSTEXPR const char CLAP_EXT_PARAMS_ORIGIN[] = "clap.params-origin/1";
...
typedef struct clap_plugin_params_origin {
...
} clap_plugin_params_origin_t;

typedef struct clap_host_params_origin {
