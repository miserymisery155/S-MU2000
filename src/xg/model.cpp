...
const std::vector<param> TABLE = {
	...
	{ "variation.part",       "Var Part",    area::effect, 0x02, 0x01, 0x5b, 1, coding::byte7,  0,     31,   127, 127,   view::part_off, 0,   nullptr },
	...
	{ "part.rcv_channel",     "Rcv Ch",      area::part, 0x08, 0, 0x04, 1, coding::byte7,  0,    31,  127, 0,    view::raw,    0,    nullptr },
